...
export default function App() {
  ...
  const scrollTo = (id: string) => {
    // Convert nav link name to section id (e.g. 'Case Laws' -> 'case-laws')
  ...
  return (
    <div className="ra-root">
      ...
      <section id="home" className="ra-hero">
        ...
        <div className="ra-hero__3d">
          <div className="ra-hero3d__scene">
            {/* Outer orbit ring with rotating badges */}
            <div className="ra-hero3d__orbit ra-hero3d__orbit--outer">
              ...
              <div className="ra-hero3d__badge ra-hero3d__badge--4"><span>LHC</span><small>High Court</small></div>
            </div>
            {/* Inner orbit ring */}
            <div className="ra-hero3d__orbit ra-hero3d__orbit--inner">
              <div className="ra-hero3d__dot ra-hero3d__dot--1" />
              <div className="ra-hero3d__dot ra-hero3d__dot--2" />
              <div className="ra-hero3d__dot ra-hero3d__dot--3" />
            </div>
            {/* Center card */}
      ...
      <a href="https://wa.me/923164371096" target="_blank" rel="noopener noreferrer" className="ra-wa-float" title="Chat on WhatsApp">
        ...
        <span className="ra-wa-float__txt">WhatsApp</span>
      </a>
