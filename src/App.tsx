...
export default function App() {
  ...
  return (
    <div className="ra-root">
          ...
          <div className="ra-certs__images">
            <div className="ra-cert-img-card ra-cert-img-card--harvard">
              ...
              <div className="ra-cert-img-card__frame">
                <img
                  src="/certificates/harvard-certificate.jpg"
                  alt="HarvardX Certificate — Contract Law"
      ...
      <a href="https://wa.me/923164371096" target="_blank" rel="noopener noreferrer" className="ra-wa-right" title="Chat on WhatsApp">
