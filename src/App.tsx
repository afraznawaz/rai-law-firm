...
const STATS = [
  ...
  { value: 'Hundreds of', label: 'Cases Won' },
...
export default function App() {
  ...
  const scrollTo = (id: string) => {
    ...
    if (lower === 'lawyer list' || lower === 'lawyers') {
  ...
  if (openCerts) {
    return (
      <div>
        <Certificates onBack={() => setOpenCerts(false)} />
      </div>
    )
  }
  ...
  if (openNews) {
    return (
      <div>
        <NewsEvents onBack={() => setOpenNews(false)} />
      </div>
    )
  }
  ...
  if (openPost) {
    return (
      <div>
        <nav className="ra-nav ra-nav--scrolled">
          <div className="ra-nav__inner">
            <div className="ra-nav__logo" onClick={closeBlogPost} style={{ cursor: 'pointer' }}>
              <img src="/uploads/upload_1.PNG" alt="RAI & Associates" className="ra-nav__logo-img" />
              <div className="ra-nav__logo-text">
                <span className="ra-nav__logo-name">RAI & ASSOCIATES</span>
                <span className="ra-nav__logo-sub">Law Firm — Est. 1993</span>
        ...
        <BlogPost slug={openPost} onBack={closeBlogPost} />
      </div>
    )
  }
    ...
    <div className="ra-root">
      ...
      <section className="ra-section ra-services">
        <div className="ra-container">
          ...
          <div className="ra-services__grid">
            {SERVICES.map((s, i) => {
              const serviceKeys = ['tax-law','civil-litigation','corporate-law','property-law','family-law','criminal-defense','contract-drafting','constitutional-law','intellectual-property','cybercrime-fia','environmental-law','revenue-law']
              return (
              <div key={i} className="ra-service-card" onClick={() => setOpenService(openService === i ? null : i)}>
                ...
                <div className="ra-service-card__footer">
                  <button className="ra-service-card__toggle" onClick={e => { e.stopPropagation(); setActiveServicePage(serviceKeys[i]) }}>
                    View Details ↓
                  </button>
          ...
          <div className="ra-expert-duo">
            <div className="ra-expert-solo ra-expert-solo--founder">
              <div className="ra-expert-solo__photo-wrap">
                <div className="ra-expert-solo__photo-bg">
                  <img src="/images/expert-bg.png" alt="Legal Background" className="ra-expert-solo__bg-img" loading="eager" decoding="async" />
                  <img src="/uploads/rai-haq-nawaz.jpg" alt="Rai Haq Nawaz Kharal" className="ra-expert-solo__photo" loading="eager" decoding="async" />
            ...
            <div className="ra-expert-solo">
              <div className="ra-expert-solo__photo-wrap">
                <div className="ra-expert-solo__photo-bg">
                  <img src="/images/expert-bg.png" alt="Legal Background" className="ra-expert-solo__bg-img" loading="eager" decoding="async" />
                  <img src="/uploads/rai-afraz.jpg" alt="Rai Afraz" className="ra-expert-solo__photo" loading="eager" decoding="async" />
      ...
      <section className="ra-section ra-blog">
        <div className="ra-container">
          ...
          <div className="ra-blog__social-bar">
            <span className="ra-blog__social-bar-label">Follow Us For Legal Updates:</span>
            <div className="ra-blog__social-bar-icons">
              <a href="https://www.facebook.com/61577203114572" target="_blank" rel="noopener noreferrer" className="ra-blog__sicon" style={{'--sc':'#1877f2'} as React.CSSProperties} title="Facebook R&A">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.facebook.com/raiafraz10" target="_blank" rel="noopener noreferrer" className="ra-blog__sicon" style={{'--sc':'#1877f2'} as React.CSSProperties} title="Facebook Rai Afraz">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.tiktok.com/@rai_associates" target="_blank" rel="noopener noreferrer" className="ra-blog__sicon" style={{'--sc':'#010101'} as React.CSSProperties} title="TikTok">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
              </a>
              <a href="https://www.instagram.com/rai_associates10" target="_blank" rel="noopener noreferrer" className="ra-blog__sicon" style={{'--sc':'#e1306c'} as React.CSSProperties} title="Instagram">
              ...
              <a href="https://www.youtube.com/@raiandassociates" target="_blank" rel="noopener noreferrer" className="ra-blog__sicon" style={{'--sc':'#ff0000'} as React.CSSProperties} title="YouTube">
              ...
              <a href="https://wa.me/923164371096" target="_blank" rel="noopener noreferrer" className="ra-blog__sicon" style={{'--sc':'#25d366'} as React.CSSProperties} title="WhatsApp">
      ...
      <section className="ra-section ra-reviews">
        <div className="ra-container">
          ...
          <div className="ra-section__header">
            ...
            <div className="ra-divider ra-divider--center" />
            <p className="ra-section__subtitle">Genuine reviews from verified clients across Pakistan</p>
          </div>

          {/* GOOGLE TRUST BANNER */}
          <div className="ra-rev__trust-banner">
            <div className="ra-rev__trust-left">
              <svg viewBox="0 0 24 24" width="36" height="36" className="ra-rev__g-logo"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
              <div>
                <div className="ra-rev__trust-score">5.0 <span className="ra-rev__trust-stars">★★★★★</span></div>
                <div className="ra-rev__trust-label">Verified on Google Business</div>
              </div>
            </div>
            <div className="ra-rev__trust-divider" />
            <div className="ra-rev__trust-mid">
              <span className="ra-rev__trust-badge">✓ Verified Reviews</span>
              <span className="ra-rev__trust-badge">✓ Real Pakistani Clients</span>
              <span className="ra-rev__trust-badge">✓ All Services Covered</span>
            </div>
            <a href="https://share.google/I3PEGQ8uMA6DyWueH" target="_blank" rel="noopener noreferrer" className="ra-rev__view-google">
          ...
          {reviewsLoading ? (
            ...
            <>
              <div className="ra-reviews__featured">
                {reviews.map((r, i) => (
                  <div key={r.id} className={`ra-reviews__slide ${i === activeReview ? 'active' : ''}`}>
                    <div className="ra-rev__slide-gverified">
              ...
              <div className="ra-reviews__grid">
                {reviews.map((r) => (
                  <div key={r.id} className="ra-review-card">
                    ...
                    <div className="ra-review-card__footer">
                      <span className="ra-review-card__service">{r.service}</span>
                      <span className="ra-review-card__verified">
                        <svg viewBox="0 0 24 24" width="11" height="11"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
                        Verified
                      </span>
                    </div>
                  </div>
              ...
              {/* BOTTOM CTA BAR */}
              <div className="ra-rev__bottom-bar">
                <div className="ra-rev__bottom-left">
                  <div className="ra-rev__bottom-score">
                    <span className="ra-rev__bottom-num">5.0</span>
                    <span className="ra-rev__bottom-stars">★★★★★</span>
                  </div>
                  <div className="ra-rev__bottom-info">
                    <div className="ra-rev__bottom-count">{reviews.length}+ Verified Client Reviews</div>
                    <div className="ra-rev__bottom-sub">Reviews sourced from real clients across Pakistan</div>
                  </div>
                </div>
                <div className="ra-rev__bottom-actions">
                  <a href="https://share.google/I3PEGQ8uMA6DyWueH" target="_blank" rel="noopener noreferrer" className="ra-rev__google-btn">
                    <svg viewBox="0 0 24 24" width="20" height="20"><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l3.66-2.84z"/><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"/></svg>
                    View More on Google
                  </a>
                  <a href="https://share.google/I3PEGQ8uMA6DyWueH" target="_blank" rel="noopener noreferrer" className="ra-rev__leave-btn">
                    + Leave a Review
                  </a>
                </div>
              </div>
      ...
      <footer className="ra-footer">
        <div className="ra-container">
          ...
          <div className="ra-footer__legal-links">
      ...
      <div style={{display:'none'}}>
        ...
        <a href="https://www.tiktok.com/@rai_associates" target="_blank" rel="noopener noreferrer" className="ra-social-float__icon" style={{'--sc':'#010101'} as React.CSSProperties} title="TikTok">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
        </a>
        <a href="https://www.instagram.com/rai_associates10" target="_blank" rel="noopener noreferrer" className="ra-social-float__icon" style={{'--sc':'#e1306c'} as React.CSSProperties} title="Instagram">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
        </a>
        <a href="https://www.youtube.com/@raiandassociates" target="_blank" rel="noopener noreferrer" className="ra-social-float__icon" style={{'--sc':'#ff0000'} as React.CSSProperties} title="YouTube">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.495 6.205a3.007 3.007 0 0 0-2.088-2.088c-1.87-.501-9.396-.501-9.396-.501s-7.507-.01-9.396.501A3.007 3.007 0 0 0 .527 6.205a31.247 31.247 0 0 0-.522 5.805 31.247 31.247 0 0 0 .522 5.783 3.007 3.007 0 0 0 2.088 2.088c1.868.502 9.396.502 9.396.502s7.506 0 9.396-.502a3.007 3.007 0 0 0 2.088-2.088 31.247 31.247 0 0 0 .5-5.783 31.247 31.247 0 0 0-.5-5.805zM9.609 15.601V8.408l6.264 3.602z"/></svg>
        </a>
        <a href="https://wa.me/923164371096" target="_blank" rel="noopener noreferrer" className="ra-social-float__icon" style={{'--sc':'#25d366'} as React.CSSProperties} title="WhatsApp">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
        </a>
      </div>

      {/* LEFT SIDE SOCIAL ICONS */}
      <div className="ra-side-social">
        <a href="https://www.facebook.com/61577203114572" target="_blank" rel="noopener noreferrer" className="ra-side-social__link ra-side-social__fb" title="Facebook">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
        </a>
        <a href="https://www.instagram.com/rai_associates10" target="_blank" rel="noopener noreferrer" className="ra-side-social__link ra-side-social__ig" title="Instagram">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
        </a>
        <a href="https://www.youtube.com/@raiandassociates" target="_blank" rel="noopener noreferrer" className="ra-side-social__link ra-side-social__yt" title="YouTube">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
        </a>
        <a href="https://www.tiktok.com/@rai_associates" target="_blank" rel="noopener noreferrer" className="ra-side-social__link ra-side-social__tt" title="TikTok">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/></svg>
        </a>
        <a href="https://www.linkedin.com/company/rai-associates-law-firm" target="_blank" rel="noopener noreferrer" className="ra-side-social__link ra-side-social__li" title="LinkedIn">
      ...
      {/* WHATSAPP FLOATING BUTTON */}
      <a href="https://wa.me/923164371096" target="_blank" rel="noopener noreferrer" className="ra-float-wa" title="Chat on WhatsApp">
        <svg viewBox="0 0 24 24" fill="currentColor" className="ra-float-wa__icon">
          <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
        </svg>
        <span className="ra-float-wa__label">WhatsApp</span>
      </a>
      ...
      {activeServicePage && (
        <div className="svc-overlay">
          <ServiceDetail
            serviceKey={activeServicePage}
            onBack={() => setActiveServicePage(null)}
            onContact={() => { setActiveServicePage(null); setTimeout(() => scrollTo('contact'), 100) }}
          />
        </div>
      )}
