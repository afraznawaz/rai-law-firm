      ...
      <div className="adm-login">
        <div className="adm-login__box">
          <div className="adm-login__logo">
            <img src="/uploads/upload_1.PNG" alt="RAI & Associates" />
          </div>
    ...
    <div className="adm-root">
      ...
      <aside className="adm-sidebar">
        ...
        <nav className="adm-sidebar__nav">
          ...
          <button className="adm-sidebar__link" onClick={openNew}>✏️ New Post</button>
        ...
        {view === 'list' && (
          <div>
            <div className="adm-header">
              ...
              <button className="adm-btn adm-btn--gold" onClick={openNew}>+ New Post</button>
            </div>
            {loading ? (
              <div className="adm-loading">Loading posts...</div>
            ) : (
                ...
                {posts.map(post => (
                  <div key={post.id} className="adm-post-card">
                    ...
                    <div className="adm-post-card__actions">
                      <button className="adm-btn adm-btn--sm adm-btn--outline" onClick={() => openEdit(post)}>✏️ Edit</button>
              ...
              <div className="adm-editor__grid">
                <div className="adm-editor__main">
                  ...
                  <div className="adm-form__group">
                    ...
                    <textarea rows={3} required placeholder="A brief 1-2 sentence summary shown on the blog list..." value={editPost.excerpt}
                      onChange={e => setEditPost({ ...editPost, excerpt: e.target.value })} />
                  </div>
                  <div className="adm-form__group">
                    <label>Full Article Content *</label>
                    <div className="adm-form__hint">Tip: Use **bold text** with double asterisks. Separate paragraphs with a blank line.</div>
                    <textarea rows={18} required placeholder="Write your full article here...&#10;&#10;Use **bold** for important terms.&#10;&#10;Separate sections with blank lines." value={editPost.content}
