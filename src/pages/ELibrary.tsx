        ...
        <div className="elib-detail__wrap">
          ...
          <div className="elib-social-section">
            ...
            <div className="elib-social-section__links">
              ...
              <a href="https://www.facebook.com/raiafraz10" target="_blank" rel="noopener noreferrer" className="elib-social-btn elib-social-btn--fb"><FacebookIcon size={18} /><span>Rai Afraz</span></a>
      ...
      <div className="elib-hero">
        <div className="elib-hero__content">
          ...
          <div className="elib-search">
            ...
            <input className="elib-search__input" placeholder="Search laws, acts, ordinances..." value={search} onChange={e => setSearch(e.target.value)} />
          </div>
        </div>
      </div>
      <div className="elib-body">
        ...
        <div className="elib-content">
          <div className="elib-content__header">
            ...
            {search && <button className="elib-content__clear" onClick={() => setSearch('')}>× Clear</button>}
          </div>
          {loading ? (
            <div className="elib-grid">{[1,2,3,4,5,6].map(i => <div key={i} className="elib-skeleton" />)}</div>
          ) : filtered.length === 0 ? (
            <div className="elib-empty"><div className="elib-empty__icon">📜</div><p>No laws found.</p></div>
          ) : (
